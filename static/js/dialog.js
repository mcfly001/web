var IMAGESPATH = 'img/dialogbox/'; //图片路径配置
...
Dialog.prototype.create = function() {
    ...
    if (this.Width && this.Height) {
        tableStyle = "width=\"" + (this.Width + 26).toString("10") + "\"";
        containStyle = "width:" + this.Width + "px; height: " + this.Height + "px;"
    } else {
        tableStyle = "";
        containStyle = "padding:0 77px";
    }
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" ' + tableStyle + ' cellspacing="0" cellpadding="0" border="0"  style="font-size:12px; line-height:1.4;">\
    ...
    <tr valign="top">\
      ...
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          ...
          <tr>\
            <td valign="top" align="center"><div id="_Container_' + this.ID + '" style="position: relative;overflow-y: auto;' + containStyle + '">\
    ...
    ' + (function(obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="56"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: center; background-color:#f6f6f6;">\
    ...
    <tr>\
      <td width="13" style="height:13px;background-image: url(' + IMAGESPATH + 'dialog_lb.png) !important;background: url(' + IMAGESPATH + 'dialog_lb.gif) no-repeat 0 bottom;"></td>\
      <td style="height:13px;background-image: url(' + IMAGESPATH + 'dialog_cb.png) !important;background: url(' + IMAGESPATH + 'dialog_cb.gif) repeat-x bottom;"></td>\
      <td width="13" style="height:13px;background-image: url(' + IMAGESPATH + 'dialog_rb.png) !important;background: url(' + IMAGESPATH + 'dialog_rb.gif) no-repeat right bottom;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
      </table>\
</div>\
    '
...
Dialog.prototype.show = function() {
    ...
    var bgdiv = Dialog.getBgdiv(),
        thisdialogDiv = this.getDialogDiv();
    if (thisdialogDiv.style.top < 0)
        thisdialogDiv.style.top = 0;
...
Dialog.getBgdiv = function() {
    ...
    if (!bgdiv) {
        ...
        var bgIframeMask = '<div style="position:fixed;background-color:#333;opacity:0.4;filter:alpha(opacity=0);width:100%;height:100%;"></div>';
