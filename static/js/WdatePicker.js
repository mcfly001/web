...
(function() {
    ...
    if ($.$crossFrame) {
        try {
            while (U.parent != U && U.parent[M][C]("frameset").length == 0) U = U.parent } catch (N) {} }
    ...
    function I(G, _) {
        ...
        function E(I, H) {
            ...
            var _ = $.$langList,
                C = $.$skinList,
                F;
            try { F = I.lastChild.contentWindow[M] } catch (D) { E = true;
